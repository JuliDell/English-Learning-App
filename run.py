phrasal_verbs = {
    ...
    {"english": "bring up", "portuguese": "mencionar, criar (criança)"},
    ...
    {"english": "get off", "portuguese": "descer de (um veículo)"},
    {"english": "get on", "portuguese": "subir em (um veículo)"},
    ...
    {"english": "hang up", "portuguese": "desligar (telefone)"},
    ...
    {"english": "make out", "portuguese": "entender, beijar apaixonadamente"},
    ...
    {"english": "put out", "portuguese": "apagar (fogo, luz)"},
    ...
    {"english": "take back", "portuguese": "retirar (o que disse), devolver"},
    {"english": "take off", "portuguese": "decolar, tirar (roupa)"},
    ...
    {"english": "watch out", "portuguese": "cuidar, prestar atenção"},
    {"english": "work out", "portuguese": "exercitar-se, resolver"},
    {"english": "write down", "portuguese": "anotar"},
    {"english": "break down", "portuguese": "quebrar, falhar"},
    ...
    {"english": "bring up", "portuguese": "criar (criança), mencionar"},
    ...
    {"english": "come down", "portuguese": "descer, cair"},
    {"english": "come off", "portuguese": "dar certo, desprender-se"},
